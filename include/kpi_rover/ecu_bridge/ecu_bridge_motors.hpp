...
namespace kpi_rover
{
    ...
    /**
     * @brief ECUBridgeMotors implements the protocol layer with a queued request mechanism.
     *
     ...
     */
    class ECUBridgeMotors: public ECUBridge
    {
    public:
        /**
         * @brief Constructor.
         ...
         */
        explicit ECUBridgeMotors(std::unique_ptr<Transport> transport);
        
        /**
         * @brief Destructor.
         */
        ~ECUBridgeMotors() override;
